...
// @version      6.6.0-dev.19
// @description  Rondo es el script de vigilancia de flota de AE-TrackRondo. Corre sobre la API nativa de Wialon o AE-Track y evalua reglas de negocio, notifica con toasts/voz/pitido, automatiza la apertura y acomodo de ventanas de unidades y mantiene abiertas solo las seleccionadas. Panel con 8 pestanas: Dashboard, Unidades, Avisos, Rutas, Zonas, Caravana, Replay y Chat IA (zonas de alto riesgo con dona SVG, histograma, KPIs clicables, slider, drag-and-drop y export CSV/GeoJSON). Unidades en tarjetas responsivas sin desbordes. Rutas con OpenStreetMap (OSRM), algoritmo A*, trazado automatico al asignar destino, deteccion de desvios, giros en U, retorno por viaje cancelado y trazado con exportacion GeoJSON. Incluye odometro por unidad, limite de velocidad por unidad, perfiles de configuracion, filtros, tema oscuro/claro, backup JSON y barra lateral redimensionable. Tamano de interfaz ajustable. IA de razonamiento: analisis por aviso, analisis en lote del dia, resumen narrativo del informe y deteccion de patrones con sugerencias aplicables. Rutas multipunto (secuencial o mejor ruta), municipios de OpenStreetMap con tolerancia de desvio, busqueda difusa de geocercas/municipios, geocercas con KPIs y exportacion, y monitor de flota con IA. Replay del dia por unidad con mini-mapa propio de OpenStreetMap. Sin emojis.
...
// @require      https://raw.githubusercontent.com/leriart/AE-Track/dev/dist/v6.6.0-dev.19/rondo-core.js
// @require      https://raw.githubusercontent.com/leriart/AE-Track/dev/dist/v6.6.0-dev.19/rondo-engine.js
// @require      https://raw.githubusercontent.com/leriart/AE-Track/dev/dist/v6.6.0-dev.19/rondo-ui.js
// @match        *://*.ae-track.com/*
// @match        *://ae-track.com/*
// @match        *://*.wialon.com/*
// @match        *://wialon.com/*
