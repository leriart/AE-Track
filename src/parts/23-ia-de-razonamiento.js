...
- Replay: reproduce el recorrido de una unidad en un dia, con mini-mapa (tiles de OpenStreetMap), linea de tiempo, resumen del dia, lista de paradas (hora, duracion, zona/municipio) y eventos (geocercas, excesos, desvios). Exporta el recorrido a GeoJSON y las paradas a CSV. Solo lectura.
